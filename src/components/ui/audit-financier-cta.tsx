            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <h2 className="font-serif text-3xl leading-tight text-white md:text-4xl lg:text-5xl">
                ...
                <span className="bg-gradient-to-r from-primary via-emerald-300 to-primary bg-clip-text text-transparent">
                  prochain exercice d&apos;audit.
                </span>
              </h2>

              <p className="mt-6 max-w-xl text-sm leading-7 text-white/50 md:text-base">
                Que vous prépariez une certification légale, un audit
                contractuel ou une mission spécifique, nous sommes disponibles
                pour comprendre votre contexte et vous proposer une approche
                adaptée.
              </p>
            ...
            {CONTACT_OPTIONS.map((option) => {
              ...
              return (
                <Link
                  key={option.title}
                  href={option.href}
                  className={`group flex flex-1 flex-col justify-between border p-8 transition-all md:p-8 ${
                    option.primary
