      ...
      <div className="relative z-10 w-full px-6 pb-16 pt-32 sm:px-10 md:pt-40 lg:pb-24">
        <div className="max-w-4xl">
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <Link href="/contact" className="inline-flex items-center justify-center gap-3 border border-white/15 bg-white/[0.03] px-8 py-4 text-[14px] font-semibold text-white/80 transition-all hover:border-white/25 hover:bg-white/[0.08] hover:text-white">
