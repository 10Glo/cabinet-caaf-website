...
// ─── Certifications ──────────────────────────────────────
const CERTIFICATIONS = ['Membre CNCC', 'Inscrit OEC', 'Normes ISA', 'OHADA Conforme', 'IFRS']
...
export default function Hero() {
  ...
  return (
    <section className="hero-section relative w-full overflow-hidden bg-brand-navy">
      ...
      {/* ── Grain overlay ── */}
      <div aria-hidden className="pointer-events-none absolute inset-0 z-[2] hero-grain" />
            ...
            <div className="flex flex-col justify-center lg:col-span-6">
              ...
              <div className={a('d3')}>
                <p className="mt-11 max-w-xl text-[17px] leading-[1.8] text-white/65">
                  Plus de 55 ans au service des entreprises et institutions en RDC. Audit financier,
                  commissariat aux comptes, conseil fiscal — avec la rigueur des{' '}
                  <span className="font-medium text-white/90">normes internationales</span> et une
                  expertise terrain éprouvée.
                </p>
              </div>
        ...
        <div className={fadeIn('d8')}>
          <div className="border-t border-white/[0.08]">
            <div className="flex items-center px-6 py-7 sm:px-10">
              ...
              <div className="relative flex flex-1 overflow-hidden hero-marquee-mask">
